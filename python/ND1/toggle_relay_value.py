...
"""Minimal example of toggling a single relay line."""
...
if __name__ == "__main__":
    """
    There are 8 relay lines available for each ND1 starting from 0-7 lines, of which any one line toggling is seen in the example.
    ...
    """
    try:
        toggle_line_value("/dev/Slot1-GPIOA", 0)
