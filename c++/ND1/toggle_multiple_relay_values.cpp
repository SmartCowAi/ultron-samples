...
/*
    There are 8 relay lines available for each ND1 starting from 0-7 lines, here we toggle all 8 outputs every 5 seconds.
...
const ::gpiod::line::offsets line_offsets = { 0, 1, 2, 3, 4, 5, 6, 7 };
